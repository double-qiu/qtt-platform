...
<div id="sidebar">
	...
	<ul class="nav nav-list">
		...
		<li><a href="#" class="dropdown-toggle"> <i
				class="icon-edit"></i> <span>Forms</span> <b
				class="arrow icon-angle-down"></b>
		</a>
			<ul class="submenu">
		...
		<li><a href="calendar.html"> <i class="icon-calendar"></i> <span>Calendar</span>
		</a></li>
		...
		<li><a href="#" class="dropdown-toggle"> <i
			...
			<ul class="submenu">
				...
				<li><a href="blank.html"><i class="icon-double-angle-right"></i>
						Blank Page</a></li>
			</ul></li>
	</ul>
	<!--/.nav-list-->
