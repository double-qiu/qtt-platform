...
<head>
  ...
  <title>UFDOUBLE</title>
<%--   <link rel="stylesheet" href="${contextPath}/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="${contextPath}/lib/font-awesome-4.5.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="${contextPath}/lib/ionicons-2.0.1/css/ionicons.min.css">
  ...
  <link rel="stylesheet" href="${contextPath}/plugins/bootstrap3-dialog/css/bootstrap-dialog.min.css">
  <link rel="stylesheet" href="${contextPath}/dist/css/validform.css">
  <link rel="stylesheet" href="${contextPath}/dist/css/style.css"> --%>
  <link rel="stylesheet" href="${contextPath}/css/bootstrap.min.css" rel="stylesheet" />
  <link rel="stylesheet" href="${contextPath}/css/bootstrap-responsive.min.css" rel="stylesheet" />
  <link rel="stylesheet" href="${contextPath}/css/font-awesome.min.css" />
  <link rel="stylesheet" href="${contextPath}/css/ace.min.css" />
  <link rel="stylesheet" href="${contextPath}/css/ace-responsive.min.css" />
  <link rel="stylesheet" href="${contextPath}/css/ace-skins.min.css" />
  ...
  <script src="${contextPath}/plugins/bootstrap3-dialog/js/bootstrap-dialog.min.js"></script>
  ...
  <script type="text/javascript" src="${contextPath}/1.9.1/jquery.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/jquery-ui-1.10.2.custom.min.js"></script>
  ...
  <script type="text/javascript" src="${contextPath}/js/jquery.easy-pie-chart.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/jquery.sparkline.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/jquery.flot.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/jquery.flot.pie.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/jquery.flot.resize.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/ace-elements.min.js"></script>
  <script type="text/javascript" src="${contextPath}/js/ace.min.js"></script>
</head>
